...
import { hasUserRole } from "../../features/auth/user-roles"
...
export function ManagementOnboardingPage() {
  ...
  const isChecking =
    currentUserQuery.isPending || (isOwner && storesQuery.isPending)
  const isError = currentUserQuery.isError || (isOwner && storesQuery.isError)

  if (isOwner && storesQuery.data && storesQuery.data.length > 0) {
